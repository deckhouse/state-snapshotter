...
См. **[Руководство пользователя](USER_GUIDE_RU.md)** — как работает ресурс `Snapshot`: что он захватывает, его жизненный цикл, как создать снимок, отслеживать его, читать и восстанавливать.
