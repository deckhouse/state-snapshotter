...
| **INV-REF-M1** / **INV-REF-M2** (parent-owned запись в **`children*Refs`**, child controllers не self-register, [`05`](../design/demo-domain-dsc/05-tree-and-graph-invariants.md) §1) | **1** + интеграционные ассерты на owner parent graph; негатив на отсутствие child-side parent patch |
