...
**Контракт записи refs (владение на родителе).** Детали ключа элемента и patch — в normative spec для PR5 (см. [`03-snapshot-flow.md`](03-snapshot-flow.md), [`02-dsc-wiring.md`](02-dsc-wiring.md)).
