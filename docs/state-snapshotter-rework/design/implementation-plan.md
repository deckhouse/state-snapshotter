...
2. На parent snapshot: **`childrenSnapshotRefs`** — полный declarative planned graph; после discovery/create — `ChildrenSnapshotReady=True`.
