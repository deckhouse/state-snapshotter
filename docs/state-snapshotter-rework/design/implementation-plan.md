...
Единый контракт чтения состояния дочернего узла; каскад **Ready**; **INV-R4** / согласованный выбор **reason** на родителе (см. [`demo-domain-dsc/07-ready-delete-matrix.md`](demo-domain-dsc/07-ready-delete-matrix.md)) — без дублирования таблиц здесь. **Рекомендуемый порядок:** после **§3-E5** выше; актуальный статус — [`operations/project-status.md`](../operations/project-status.md).
