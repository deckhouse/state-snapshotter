...
const (
	APIGroup   = "state-snapshotter.deckhouse.io"
	APIVersion = "v1alpha1"
)
...
func addKnownTypes(scheme *runtime.Scheme) error {
	scheme.AddKnownTypes(SchemeGroupVersion,
		...
		&SnapshotImportRequestList{},
		&SnapshotImportManifestChunk{},
		&SnapshotImportManifestChunkList{},
...
// ObjectReference is not a Kubernetes resource, so it doesn't need to be registered
// It's just a helper type used in other resources
