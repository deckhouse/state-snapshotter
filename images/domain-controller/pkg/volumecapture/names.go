...
// snapshot, keyed by the snapshot UID. The request name is derivable from the snapshot alone, without
// reading SnapshotContent (content-ownership decoupling, D3).
