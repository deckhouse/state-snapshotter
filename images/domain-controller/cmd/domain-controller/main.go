...
func main() {
	...
	// of MaxConcurrentReconciles. This is the demo planning controller; a production domain controller
	// is expected to choose its own values — these are not part of any contract.
	const (
		kubeClientQPS   = 200
		kubeClientBurst = 400
	)
	...
	log.Info("[domain-main] kubernetes client rate limiter configured",
		"qps", kConfig.QPS,
		"burst", kConfig.Burst,
	)
