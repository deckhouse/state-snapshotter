...
func snapNodeUnstructured(name, apiVersion, kind, boundContent string, children ...storagev1alpha1.SnapshotChildRef) *unstructured.Unstructured {
...
func snapNode(name, boundContent string, children ...storagev1alpha1.SnapshotChildRef) *storagev1alpha1.Snapshot {
...
func TestCollectSubtreeCoveredPVCUIDsFromSnapshot_directChildren(t *testing.T) {
	t.Parallel()
	childA := snapNode("child-a", "content-a")
	childB := snapNode("child-b", "content-b")
	root := snapNode("root", "", snapChildRef("child-a"), snapChildRef("child-b"))
...
func TestCollectSubtreeCoveredPVCUIDsFromSnapshot_nestedAggregator(t *testing.T) {
	...
	grandchild := snapNode("disk", "content-disk")
	aggregator := snapNodeUnstructured("vm", storagev1alpha1.SchemeGroupVersion.String(), "AggregatorSnapshot", "content-vm", snapChildRef("disk"))
	root := snapNode("root", "", aggChildRef("vm"))
...
func TestCollectSubtreeCoveredPVCUIDsFromSnapshot_missingChildFailsClosed(t *testing.T) {
	...
	root := snapNode("root", "", snapChildRef("ghost"))
...
func TestCollectSubtreeCoveredPVCUIDsFromSnapshot_missingBoundContentFailsClosed(t *testing.T) {
	...
	child := snapNode("child", "gone-content")
	root := snapNode("root", "", snapChildRef("child"))
...
func TestCollectSubtreeCoveredPVCUIDsFromSnapshot_unboundNonDataBearingChildContributesNothing(t *testing.T) {
	...
	child := snapNodeUnstructured("child", storagev1alpha1.SchemeGroupVersion.String(), "AggregatorSnapshot", "")
	root := snapNode("root", "", aggChildRef("child"))
...
func TestCollectSubtreeCoveredPVCUIDsFromSnapshot_boundManifestOnlyChildContributesNothing(t *testing.T) {
	...
	child := snapNodeUnstructured("child", storagev1alpha1.SchemeGroupVersion.String(), "AggregatorSnapshot", "content-empty")
	root := snapNode("root", "", aggChildRef("child"))
...
func TestCollectSubtreeCoveredPVCUIDsFromSnapshot_plannedUnboundChildCoveredViaOwnerVCR(t *testing.T) {
	...
	child := withCaptureVCRName(snapNodeUnstructured("child", storagev1alpha1.SchemeGroupVersion.String(), "Snapshot", ""), "vcr-child")
	root := snapNode("root", "", snapChildRef("child"))
