...
// (the storage.deckhouse.io variant lives in integration_exportimport_crd.go). spec and status use
// x-kubernetes-preserve-unknown-fields so simulated fields are not pruned.
