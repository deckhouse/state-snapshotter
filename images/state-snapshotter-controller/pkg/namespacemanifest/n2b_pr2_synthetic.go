...
// N2b PR2: one synthetic NamespaceSnapshot child for graph/reconcile semantics only (not product flow).
// See design implementation-plan §2.4.2 PR2 and namespace-snapshot-controller.md N2b.
...
const (
	...
	// LabelN2bParentName and LabelN2bParentUID on the synthetic child link it to the parent for watch map and validation.
