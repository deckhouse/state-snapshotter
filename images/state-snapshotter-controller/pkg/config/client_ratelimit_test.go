...
func TestResolveClientRateLimit(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "override qps only", qpsRaw: "500", wantQPS: 500, wantBurst: defBurst},
		{name: "override burst only", burstRaw: "1000", wantQPS: defQPS, wantBurst: 1000},
		{name: "fractional qps", qpsRaw: "12.5", burstRaw: "20", wantQPS: 12.5, wantBurst: 20},
		{name: "invalid qps", qpsRaw: "abc", burstRaw: "100", wantErr: true},
		{name: "zero qps", qpsRaw: "0", wantErr: true},
		{name: "negative qps", qpsRaw: "-1", wantErr: true},
		{name: "invalid burst", qpsRaw: "50", burstRaw: "x", wantErr: true},
		{name: "fractional burst rejected", burstRaw: "10.5", wantErr: true},
		{name: "zero burst", burstRaw: "0", wantErr: true},
