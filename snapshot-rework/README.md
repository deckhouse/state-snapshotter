...
**Conditions snapshot/SnapshotContent (ChildrenSnapshotReady / RequestsReady / ChildrenReady / Ready) + failure propagation:** draft ADR — [`2026-06-03-snapshot-conditions-model.md`](2026-06-03-snapshot-conditions-model.md). Нормативные выдержки переносятся в `spec/system-spec.md` §3.8 / §3.9.7.
