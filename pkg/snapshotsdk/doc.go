...
// storage-foundation VolumeCaptureRequest, owner references, optimistic-locked status patches, the
// derived planning-barrier condition, and orphan child garbage collection — is Kubernetes transport
// that this SDK hides behind a small set of intent verbs.
//
// # Model
//
...
//	if err := sdk.EnsureVolumeCapture(ctx, t, VolumeCaptureSpec{Targets: targets}); err != nil { ... }
